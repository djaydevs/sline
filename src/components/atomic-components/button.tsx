...
const buttonVariants = cva(
  "flex items-center uppercase justify-center rounded-none text-[13px] text-center font-semibold tracking-wide ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 transition duration-300 ease-linear",
  {
    variants: {
      variant: {
        default:
