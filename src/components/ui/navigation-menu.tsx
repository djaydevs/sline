...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    className={cn(
      "left-0 top-full mt-5 w-full rounded-md bg-popover data-[motion^=from-]:animate-in data-[state=open]:animate-in data-[motion^=to-]:animate-out data-[state=closed]:animate-out data-[motion^=from-]:fade-in data-[motion^=to-]:fade-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 md:absolute md:w-auto",
      className
    )}
    ref={ref}
    {...props}
